...
import com.fidev.socialspringlogin.exception.OAuth2AuthenticationProcessingException;
import com.fidev.socialspringlogin.model.AuthProvider;
...
import com.fidev.socialspringlogin.security.oauth2.user.OAuth2UserInfo;
import com.fidev.socialspringlogin.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        if(oAuth2UserInfo.getEmail().isEmpty()) throw new OAuth2AuthenticationProcessingException("Email not found from OAuth2 provider");

        Optional<User> userOptional = repository.findByEmail(oAuth2UserInfo.getEmail());
        User user;
